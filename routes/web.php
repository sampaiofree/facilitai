...
Route::middleware('auth')->prefix('agencia')->name('agencia.')->group(function () {
    ...
    Route::get('kommo', [AgenciaKommoController::class, 'index'])->name('kommo.index');
    Route::post('kommo/validate', [AgenciaKommoController::class, 'validateConnection'])->name('kommo.validate');
    Route::post('kommo/pipelines', [AgenciaKommoController::class, 'pipelines'])->name('kommo.pipelines');
    Route::post('kommo/statuses', [AgenciaKommoController::class, 'statuses'])->name('kommo.statuses');
    Route::post('kommo', [AgenciaKommoController::class, 'store'])->name('kommo.store');
    Route::patch('kommo/{kommoAccount}', [AgenciaKommoController::class, 'update'])->name('kommo.update');
    Route::delete('kommo/{kommoAccount}', [AgenciaKommoController::class, 'destroy'])->name('kommo.destroy');
    ...
    Route::get('grupos', [AgenciaGrupoController::class, 'index'])->name('grupos.index');
    Route::post('grupos', [AgenciaGrupoController::class, 'store'])->name('grupos.store');
    Route::delete('grupos/{grupoConjunto}', [AgenciaGrupoController::class, 'destroy'])->name('grupos.destroy');
    Route::get('grupos/conexoes/{conexao}/groups', [AgenciaGrupoController::class, 'connectionGroups'])->name('grupos.conexoes.groups');
    Route::get('grupos/conexoes/{conexao}/group-invite-info', [AgenciaGrupoController::class, 'connectionGroupInviteInfo'])->name('grupos.conexoes.group-invite');
    Route::post('grupos/{grupoConjunto}/mensagens', [AgenciaGrupoController::class, 'storeMessage'])->name('grupos.mensagens.store');
    Route::patch('grupos/{grupoConjunto}/mensagens/{grupoConjuntoMensagem}', [AgenciaGrupoController::class, 'updateMessage'])->name('grupos.mensagens.update');
    Route::delete('grupos/{grupoConjunto}/mensagens/{grupoConjuntoMensagem}', [AgenciaGrupoController::class, 'destroyMessage'])->name('grupos.mensagens.destroy');
    ...
    Route::get('webhook-links', [LeadWebhookLinkController::class, 'index'])->name('webhook-links.index');
    Route::post('webhook-links', [LeadWebhookLinkController::class, 'store'])->name('webhook-links.store');
    Route::get('webhook-links/{leadWebhookLink}', [LeadWebhookLinkController::class, 'edit'])->name('webhook-links.edit');
    Route::put('webhook-links/{leadWebhookLink}', [LeadWebhookLinkController::class, 'update'])->name('webhook-links.update');
    Route::patch('webhook-links/{leadWebhookLink}/status', [LeadWebhookLinkController::class, 'updateStatus'])->name('webhook-links.status');
    Route::post('webhook-links/{leadWebhookLink}/rotate-token', [LeadWebhookLinkController::class, 'rotateToken'])->name('webhook-links.rotate-token');
    Route::get('webhook-links/{leadWebhookLink}/latest-delivery', [LeadWebhookLinkController::class, 'latestDelivery'])->name('webhook-links.latest-delivery');
...
Route::prefix('cliente')->name('cliente.')->group(function () {
    ...
    Route::middleware('auth:client')->group(function () {
        ...
        Route::post('crm/pipelines', [ClienteCrmController::class, 'storePipeline'])->name('crm.pipelines.store');
        Route::patch('crm/pipelines/{crmPipeline}', [ClienteCrmController::class, 'updatePipeline'])->whereNumber('crmPipeline')->name('crm.pipelines.update');
        Route::delete('crm/pipelines/{crmPipeline}', [ClienteCrmController::class, 'destroyPipeline'])->whereNumber('crmPipeline')->name('crm.pipelines.destroy');
        ...
        Route::post('crm/{crmPipeline}/columns/{crmColumn}/leads', [ClienteCrmController::class, 'addLeadToColumn'])->whereNumber('crmPipeline')->whereNumber('crmColumn')->name('crm.columns.leads.store');
        Route::patch('crm/{crmPipeline}/leads/{clienteLead}/column', [ClienteCrmController::class, 'moveLead'])->whereNumber('crmPipeline')->whereNumber('clienteLead')->name('crm.leads.column');
        Route::delete('crm/{crmPipeline}/leads/{clienteLead}', [ClienteCrmController::class, 'removeLeadFromPipeline'])->whereNumber('crmPipeline')->whereNumber('clienteLead')->name('crm.leads.destroy');
        Route::get('crm/{crmPipeline}', [ClienteCrmController::class, 'show'])->whereNumber('crmPipeline')->name('crm.show');
        ...
        Route::get('grupos', [ClienteGrupoController::class, 'index'])->name('grupos.index');
        Route::post('grupos', [ClienteGrupoController::class, 'store'])->name('grupos.store');
        ...
        Route::get('campos-personalizados', [ClienteCustomFieldController::class, 'index'])->name('campos-personalizados.index');
        Route::post('campos-personalizados', [ClienteCustomFieldController::class, 'store'])->name('campos-personalizados.store');
        Route::patch('campos-personalizados/{campoPersonalizado}', [ClienteCustomFieldController::class, 'update'])->name('campos-personalizados.update');
        Route::delete('campos-personalizados/{campoPersonalizado}', [ClienteCustomFieldController::class, 'destroy'])->name('campos-personalizados.destroy');
        Route::get('webhook-links', [ClienteLeadWebhookLinkController::class, 'index'])->name('webhook-links.index');
        Route::post('webhook-links', [ClienteLeadWebhookLinkController::class, 'store'])->name('webhook-links.store');
        Route::get('webhook-links/{leadWebhookLink}', [ClienteLeadWebhookLinkController::class, 'edit'])->name('webhook-links.edit');
        Route::put('webhook-links/{leadWebhookLink}', [ClienteLeadWebhookLinkController::class, 'update'])->name('webhook-links.update');
        Route::patch('webhook-links/{leadWebhookLink}/status', [ClienteLeadWebhookLinkController::class, 'updateStatus'])->name('webhook-links.status');
        Route::post('webhook-links/{leadWebhookLink}/rotate-token', [ClienteLeadWebhookLinkController::class, 'rotateToken'])->name('webhook-links.rotate-token');
        Route::get('webhook-links/{leadWebhookLink}/latest-delivery', [ClienteLeadWebhookLinkController::class, 'latestDelivery'])->name('webhook-links.latest-delivery');

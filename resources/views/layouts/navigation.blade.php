@php
   $menus = [
        ...
        ['label' => 'Tokens', 'route' => 'payments.index'],
        ['label' => 'Instâncias', 'route' => 'instances.index'],
        ['label' => 'Assistentes', 'route' => 'assistants.index'],
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('storage/homepage/facilitAI.png') }}" alt="FacilitAI Logo" style="max-height: 30px;">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative group inline-flex">
                        <button class="inline-flex items-center text-gray-600 hover:text-indigo-600">
                            Ferramentas
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 max-w-full truncate">{{ Auth::user()->name }}</div>

            ...
            <nav class="px-4 py-6 space-y-1">
                ...
                <div class="relative">
                    ...
                    <div data-tools-dropdown-menu class="absolute left-0 right-0 z-10 mt-1 hidden space-y-1 rounded-lg border border-slate-800 bg-slate-900/90 p-2 shadow-lg backdrop-blur">
                        <a href="{{ route('agencia.kommo.index') }}" class="block rounded-lg px-4 py-2 text-sm font-semibold transition {{ request()->routeIs('agencia.kommo.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">Kommo</a>

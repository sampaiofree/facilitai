    ...
    <div class="min-h-screen flex">
        <aside class="w-64 shrink-0 bg-slate-900 text-slate-100 flex flex-col">
            ...
            <nav class="px-4 py-6 space-y-2">
                ...
                <a href="{{ route('adm.assistants.index') }}" class="block rounded-lg px-4 py-2 text-sm font-semibold {{ request()->routeIs('adm.assistants.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">Assistants</a>
                ...
                <a href="{{ route('adm.plano.index') }}" class="block rounded-lg px-4 py-2 text-sm font-semibold {{ request()->routeIs('adm.plano.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">Planos</a>
                ...
                <a href="{{ route('adm.agendamentos.index') }}" class="block rounded-lg px-4 py-2 text-sm font-semibold {{ request()->routeIs('adm.agendamentos.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">Agendamentos</a>
                ...
                <a href="{{ url(config('horizon.path', 'adm/horizon')) }}" class="block rounded-lg px-4 py-2 text-sm font-semibold {{ request()->is(trim(config('horizon.path', 'adm/horizon'), '/').'*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">Horizon</a>
            </nav>
